package it.ht.rcs.console.monitor.view
{
  public class PlatformIcons
  {
    
    [Embed('/img/platforms/windows.png')]
    public static const windowsOn:Class;
    
    [Embed('/img/platforms/windows_mono.png')]
    public static const windowsOff:Class;
    
    [Embed('/img/platforms/apple.png')]
    public static const osxOn:Class;
