...
internal class _UserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("enabled", "timezone", "_id", "privs", "group_ids", "name", "locale", "contact", "pass");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("enabled", "timezone", "_id", "privs", "group_ids", "name", "locale", "contact", "pass");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("enabled", "timezone", "_id", "privs", "group_ids", "name", "locale", "contact", "pass");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("enabled", "timezone", "_id", "privs", "group_ids", "name", "locale", "contact", "pass");
